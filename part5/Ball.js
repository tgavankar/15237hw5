...
var Ball = function(config){
    ...
    this.minRad = config.minRad;
    this.maxRad = config.maxRad;

}

Ball.prototype.update = function(timeDiff){
    this.radius = (this.radius < this.minRad) ? this.minRad : this.radius;
    this.radius = (this.radius > this.maxRad) ? this.maxRad : this.radius;
